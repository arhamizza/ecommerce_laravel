                                                    ...
                                                    <div class="product-thumb transition product-item-container">
                                                        <div class="left-block">
                                                            <div class="product-image-container">
                                                                ...
                                                                <div class="so-quickview">
                                                                    <a class="iframe-link btn-button quickview quickview_handler visible-lg"
                                                                        href="{{ asset('atmin/assets/uploads/produk/' . $prod->image) }}"
                                                        ...
                                                        <div class="right-block">
                                                            <div class="caption">
                                                                <h4><a href="#" target="_self"
                                                                        title="Ground round enim">{{ $prod->nama }}</a>
                                                                </h4>
                                                                <div class="rating">
                                                                    <span class="fa fa-stack"><i
                                                                            class="fa fa-star fa-stack-2x"></i></span>
                                                                ...
                                                                <p class="price"> <span
                                                                        class="price-new">{{ $prod->selling_price }}</span>
                                                                    <span
                                                                        class="price-old">{{ $prod->original_price }}</span>
                                                                </p>
                                                                <div class="button-group">
                ...
                <div class="module so-extraslider-ltr extra-layout4 cus1">
                    ...
                    <div class="modcontent">
                        <div class="so-extraslider">
                            <div class="yt-content-slider extraslider-inner products-list" data-rtl="yes"
                                data-pagination="no" data-autoplay="no" data-delay="4" data-speed="0.6"
                                data-margin="30" data-items_column0="6" data-items_column1="3" data-items_column2="2"
                                    ...
                                    <div class="product-layout product-grid2 style1">
                                        <div class="product-thumb transition product-item-container">
                                            ...
                                            <div class="right-block">
                                                <div class="caption">
                                                    <h4><a href="#" target="_self"
                                                            title="Rumstick shankle">Rumstick shankle</a></h4>
                                                    <div class="rating">
                                                        <span class="fa fa-stack"><i
                                                                class="fa fa-star fa-stack-2x"></i></span>
                                                        <span class="fa fa-stack"><i
                                    ...
                                    <div class="product-layout product-grid2 style1">
                                        <div class="product-thumb transition product-item-container">
                                            ...
                                            <div class="right-block">
                                                <div class="caption">
                                                    <h4><a href="#" target="_self"
                                                            title="Corem ipsum dolor">Corem ipsum dolor</a></h4>
                                                    <div class="rating">
                                                        <span class="fa fa-stack"><i
                                                                class="fa fa-star fa-stack-2x"></i></span>
                                                        <span class="fa fa-stack"><i
                                            ...
                                            <div class="media-content">
                                                ...
                                                <h4 class="media-heading font-title">
                                                    <a href="#"
                                                        ...
                                                        target="_self">Lorem ipsum dolor sit amet, consetetur sadipscing
                                                        elitr</a>
                                                </h4>
                                            ...
                                            <div class="media-content">
                                                ...
                                                <h4 class="media-heading font-title">
                                                    <a href="#"
                                                        ...
                                                        target="_self">Stet clita kasd gubergren no sea takimata sanctus
                                                        est</a>
                                                </h4>
                                            ...
                                            <div class="media-content">
                                                ...
                                                <h4 class="media-heading font-title">
                                                    <a href="#"
                                                        ...
                                                        target="_self">Ut wisi enim ad minim veniam quis nostrud exerci
                                                        tation</a>
                                                </h4>
                                            ...
                                            <div class="media-content">
                                                ...
                                                <h4 class="media-heading font-title">
                                                    <a href="#"
                                                        ...
                                                        target="_self">Duis autem vel eum iriure dolor in hendrerit in
                                                        vulputate</a>
                                                </h4>
