                        ...
                        <div class="box-category">
                            <ul id="cat_accordion" class="list-group">
                                @foreach ($category as $kat)
                                    <li class=""><a href="{{ url('view-category/' . $kat->slug) }}"
                                            class="cutom-parent">{{ $kat->nama }}</a> <span class="dcjq-icon"></span>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="banners">
                                    <div>
                                        <a href="#"><img
                                                src="{{ asset('atmin/assets/uploads/kategori/' . $kategori->image) }}"
                                                width="1370px" height="300px" alt="img cate"><br></a>
                                    </div>
                                </div>
                            ...
                            <div class="short-by-show form-inline text-right col-md-7 col-sm-9 col-xs-12">
                                <form action="{{ url('view-category/' . $kategori->slug) }}">
                                    <!-- <div class="form-group short-by">
                                        ...
                                        <select class="form-control" id="sorting" name="sorting" value="#">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <li><a class="text-center"
                                                        href="{{ url('view-categorylowname/' . $kategori->slug) }}">Name (A -
                                                        Z)</a></li>
                                                <li><a class="text-center"
                                                        href="{{ url('view-categoryhighname/' . $kategori->slug) }}">Name (Z
                                                        - A)</a></li>
                                                <li><a class="text-center"
                                                        href="{{ url('view-categorylowprice/' . $kategori->slug) }}">Price
                                                        (Low &gt; High)</a></li>
                                                <li><a class="text-center"
                                                        href="{{ url('view-categoryhighprice/' . $kategori->slug) }}">Price
                                                        (High &gt; Low)</a></li>
                                            </div>
                                        </div>
                                ...
                                <div class="product-item-container">
                                    <div class="left-block">
                                        <div class="product-image-container second_img">
                                            <a href="{{ url('view-category/' . $kategori->slug . '/' . $prod->slug) }}"
                                                target="_self" title="{{ $prod->nama }}">
                                                <img src="{{ asset('atmin/assets/uploads/produk/' . $prod->image) }}"
                                    ...
                                    <div class="right-block">
                                        <div class="caption">
                                            ...
                                            <h4><a href="{{ url('view-category/' . $kategori->slug . '/' . $prod->slug) }}"
                                                    title="{{ $prod->nama }}" target="_self">{{ $prod->nama }}</a>
                                            </h4>
                                            <div class="price"> <span class="price-new">Rp
                                                    {{ number_format($prod->selling_price) }}</span>
                                                <span class="price-old">Rp
                                                    {{ number_format($prod->original_price) }}</span>
                                            </div>
                            ...
                            @if (isset($produk))
                                @if ($produk->currentPage() > 1)
                                    <button type="button" data-toggle="tooltip" title="Previous"
                                        ...
                                        <a class="text-white"
                                            href="{{ $produk->previousPageUrl() }}">Previous</a></button>
